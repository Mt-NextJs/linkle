  ...
  return (
    <div className="group relative inline-block">
      <Image
        ...
        height={30}
      />
      <div className="absolute left-2 top-20 z-[9999] w-max -translate-x-1/2 -translate-y-1/2 transform rounded bg-[#343434] px-3 py-3 text-sm text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">
